...
public interface SlaveManager extends Remote {
	...
	/**
	 * Registra escravo no mestre. Deve ser chamada a cada 30s por um escravo para
	 * se re-registrar.
	 *
	 ...
	 * @throws java.rmi.RemoteException
	 */
	public void removeSlave(java.util.UUID slaveKey) throws java.rmi.RemoteException;
	...
	/**
	 * Chamado por cada escravo a cada 10s durante ataque para indicar progresso no
	 * ataque, e ao final do ataque.
	 *
	 * @param slaveKey     chave que identifica o escravo
	 * @param attackNumber chave que identifica o ataque
